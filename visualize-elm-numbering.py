...
#
#  Original by Paulo Roma
#  Modified by Michel Make
#  
    ...
    for p1 in range(nv):
        for p2 in range(p1+1, nv):
            ...
            canvas.create_line(translate(tet[0][p1], tet[1][p1], w, h),
                               translate(tet[0][p2], tet[1][p2], w, h),
                               fill=col)

    output1 = translate(tet[0][0], tet[1][0], w, h)
    canvas.create_text(output1[0],  output1[1],
                       fill="darkblue",
                       font="Times 20 italic bold",
                       text="P1.")

    output2 = translate(tet[0][1], tet[1][1], w, h)
    canvas.create_text(output2[0], output2[1],
                       fill="darkblue",
                       font="Times 20 italic bold",
                       text="P2.")

    output3 = translate(tet[0][2], tet[1][2], w, h)
    canvas.create_text(output3[0], output3[1],
                       fill="darkblue",
                       font="Times 20 italic bold",
                       text="P3.")

    output4 = translate(tet[0][3], tet[1][3], w, h)
    canvas.create_text(output4[0], output4[1],
                       fill="darkblue",
                       font="Times 20 italic bold",
                       text="P4.")

    outAVGx1 = (output1[0] + output2[0] + output3[0])/3
    outAVGy1 = (output1[1] + output2[1] + output3[1])/3

    canvas.create_text(outAVGx1, outAVGy1,
                       fill="red",
                       font="Times 20 italic bold",
                       text="S1.")

    outAVGx2 = (output1[0] + output2[0] + output4[0])/3
    outAVGy2 = (output1[1] + output2[1] + output4[1])/3

    canvas.create_text(outAVGx2, outAVGy2,
                       fill="red",
                       font="Times 20 italic bold",
                       text="S2.")

    outAVGx3 = (output4[0] + output2[0] + output3[0])/3
    outAVGy3 = (output4[1] + output2[1] + output3[1])/3

    canvas.create_text(outAVGx3, outAVGy3,
                       fill="red",
                       font="Times 20 italic bold",
                       text="S3.")

    outAVGx4 = (output1[0] + output4[0] + output3[0])/3
    outAVGy4 = (output1[1] + output4[1] + output3[1])/3

    canvas.create_text(outAVGx4, outAVGy4,
                       fill="red",
                       font="Times 20 italic bold",
                       text="S4.")
...
def resize(event):
    """Redraw the tetrahedron, in case of a window change due to user \
        resizing it."""
